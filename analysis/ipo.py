...
try:
    ...
    while True:
        ...
        table = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.ID, 'myTableEip'))
        )
        ...
        try:
            next_page_link = WebDriverWait(driver, 15).until(EC.element_to_be_clickable((By.ID, 'myTableEip_next')))
    ...
    with open('jsondata/ipo.json', 'w') as json_file:
